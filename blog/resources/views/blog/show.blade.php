		...
		<div class="content-wrap">
			<div class="content">
				<header class="article-header">
					<h1 class="article-title"><a href="#" title="用DTcms做一个独立博客网站（响应式模板）" >{{ $blog_info['title'] }}</a></h1>
					<div class="article-meta"> <span class="item article-meta-time">
	  <time class="time" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="发表时间：{{ date('Y-m-d H:i:s',$blog_info['updated_at']) }}"><i class="glyphicon glyphicon-time"></i> {{ date('Y-m-d H:i:s',$blog_info['updated_at']) }}</time>
	  </span> <span class="item article-meta-source" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="BIGO技术博客"><i class="glyphicon glyphicon-globe"></i> BIGO技术博客</span> <span class="item article-meta-category" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="{{ $blog_info['label'] }}"><i class="glyphicon glyphicon-list"></i> <a href="#" title="{{ $blog_info['label'] }}" >{{ $blog_info['label'] }}</a></span> <span class="item article-meta-views" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="浏览量：{{ $blog_info['browse'] }}"><i class="glyphicon glyphicon-eye-open"></i> {{ $blog_info['browse'] }}</span> <span class="item article-meta-comment" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="评论量：{{ $blog_info['comment'] }}"><i class="glyphicon glyphicon-comment"></i> {{ $blog_info['comment'] }}</span> </div>
				</header>
				<article class="article-content">
					<p><img data-original="images/201610181557196870.jpg" src="{{ asset('images/201610181557196870.jpg') }}" alt="" /></p>
