...
@section('content')
		...
		<div class="content">
				...
				<div class="carousel-inner" role="listbox">
					<div class="item active">
						<a href="#" target="_blank" title="木庄网络博客源码" >
							<img src="{{ asset('images//lunbo2.jpg') }}" alt="木庄网络博客源码" class="img-responsive"></a>
					</div>
					<div class="item">
						<a href="#" target="_blank" title="专业网站建设" >
							<img src="{{ asset('images//lunbo1.jpg') }}" alt="专业网站建设" class="img-responsive"></a>
					</div>
				</div>
				<a class="left carousel-control" href="#focusslide" role="button" data-slide="prev" rel="nofollow"> <span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span> <span class="sr-only">上一个</span> </a> <a class="right carousel-control" href="#focusslide" role="button" data-slide="next" rel="nofollow"> <span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span> <span class="sr-only">下一个</span> </a> </div>
			<article class="excerpt-minic excerpt-minic-index">
				<h2><span class="red">【推荐】</span><a target="_blank" href="#" title="基于Laravel的技术博客网站" >基于Laravel的技术博客网站</a>
				</h2>
				<p class="note">基于Laravel的技术博客网站基于Laravel的技术博客网站基于Laravel的技术博客网站基于Laravel的技术博客网站基于Laravel的技术博客网站基于Laravel的技术博客网站基于Laravel的技术博客网站基于Laravel的技术博客网站</p>
			</article>
			<div class="title">
				<h3>最新发布</h3>
				<div class="more">
			...
			@for($i=0;$i<4;$i++)
				<article class="excerpt excerpt-1" style="">
					<a class="focus" href="{{ url('home/show') }}" title="用DTcms做一个独立博客网站（响应式模板）" target="_blank" ><img class="thumb" data-original="images/201610181739277776.jpg" src="{{ asset('images/201610181739277776.jpg') }}" alt="用DTcms做一个独立博客网站（响应式模板）"  style="display: inline;"></a>
					<header><a class="cat" href="{{ url('home/show') }}" title="MZ-NetBlog主题" >MZ-NetBlog主题<i></i></a>
						<h2><a href="{{ url('home/show') }}" title="用DTcms做一个独立博客网站（响应式模板）" target="_blank" >用DTcms做一个独立博客网站（响应式模板）</a>
						</h2>
					</header>
					<p class="meta">
	...
	@if( session()->get('s_message') )
		layer.msg("{{ session()->get('s_message') }}");
	@endif
</script>
@endsection